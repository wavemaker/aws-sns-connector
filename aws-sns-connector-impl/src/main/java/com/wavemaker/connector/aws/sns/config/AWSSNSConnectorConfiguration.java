package com.wavemaker.connector.aws.sns.config;
...
@Configuration
@ComponentScan(basePackages = "com.wavemaker.connector.aws.sns")
public class AWSSNSConnectorConfiguration extends ConnectorConfigurationBase {
